...
const question = faker.lorem.sentence(3); // Maxime beatae est.
const answer = faker.hacker.phrase(); // If we transmit the system, we can get to the JBOD monitor through the cross-platform JSON sensor!
...
const date = faker.date.between(2015, 2020); // 2015-11-22T18:47:25.333Z
